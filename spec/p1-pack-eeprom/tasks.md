...
- **Gate (PASS):** build clean both editions; firmware 54,852 ≤ 60,928 (well under); host suites: 815,422 + 28 (edit) = **815,450 checks, 0 failures** (key 240, edit 28, pack 195, band-lock 815,004, font 155). **(hw) screenshots via `screenshot.c` over UART** for every screen + state variant — pending a real radio.
