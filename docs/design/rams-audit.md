...
| 2 | **Useful** | Good — unproven | Everything serves the race-day moment (vision §2: "the aunt with the cooler"); scan-first boot, WX/BRD one long-press away, lockout one gesture, FOLLOW | **P1 acceptance (hw):** a fan (not a ham) uses the radio for a full race without asking a question |
